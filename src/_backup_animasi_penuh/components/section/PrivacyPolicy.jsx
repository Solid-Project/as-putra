...
const PrivacyPolicy = () => {
  return (
    <LegalLayoutWrapper title="Privacy Policy" lastUpdated="May 17, 2026">
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to AS Putra Group, Jl. Jend. Sudirman No.125, Winduhaji, Kuningan, Jawa Barat 45516.</p>
        </li>
        <li>
