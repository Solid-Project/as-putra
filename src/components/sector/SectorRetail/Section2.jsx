...
import bgLayout from '@/assets/img/ceha.webp';
...
const Layout1 = () => {
  ...
  const data = {
    id: "ceha",
    title: "CEHA",
    meta: "Ayam Potong Segar",
    image: bgLayout,
    description: [
      "Kesegaran langsung dari peternakan ke meja makan Anda. Berpusat di kawasan strategis Awirarangan, Ceha hadir sebagai pusat distribusi utama untuk Telur Premium dan Ayam Potong Segar.",
    ],
  };
