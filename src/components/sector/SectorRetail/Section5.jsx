...
import bgLayout from '@/assets/img/ayamku.webp';
        ...
        <div className="grid lg:grid-cols-12 gap-0 items-start">
          ...
          <div className="lg:col-span-7 relative group">
            ...
            <div className="absolute -bottom-6 -left-6 bg-[var(--color-utama)] text-white p-8 hidden md:block shadow-xl">
               <p className="text-xs font-bold tracking-[0.3em] uppercase mb-2 opacity-80">Ayamku Fried Chicken</p>
               <h4 className="text-4xl font-black font-['Playfair_Display']"></h4>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:-ml-20 mt-12 lg:mt-32 z-20">
            ...
            >
              <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl text-slate-900 font-bold mb-8 leading-tight">
                Mengangkat cita rasa nusantara dengan standar kualitas modern
              </h2>
              <p className="text-slate-600 leading-relaxed mb-12 text-lg font-light">
             Ayamku hadir sebagai jaringan outlet fried chicken yang memadukan kelezatan premium, kebersihan maksimal, dan layanan cepat saji untuk seluruh lapisan masyarakat.
              </p>
