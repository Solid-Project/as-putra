...
import peternakanImg from "@/assets/img/tb2.webp";
          ...
          >
            <div className="max-w-xl">
              ...
              <h2 className="font-['Playfair_Display'] text-4xl md:text-6xl lg:text-7xl text-slate-900 font-bold leading-[1.1] mb-8 tracking-tighter">
                  Kelengkapan Infrastruktur Konstruksi
              </h2>
             ...
             Menyuplai komponen konstruksi secara menyeluruh, dari material dasar struktur hingga kebutuhan finishing. Kami mendukung penuh setiap visi pembangunan Anda melalui produk berstandar ketat dan berdaya tahan maksimal.
              </p>
            </div>
          </div>
