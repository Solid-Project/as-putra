...
const Layout1 = () => {
  ...
  const data = {
    id: "Grand Cordela",
    title: "Grand Cordella Hotel",
    meta: "As Putra",
    image: bgLayout,
    description: [
      "Simbol elegansi perhotelan modern. Kami menawarkan akomodasi eksklusif dengan arsitektur menawan dan layanan bertaraf profesional, menciptakan ruang istirahat yang sempurna dengan standar kenyamanan tanpa kompromi.",
    ],
  };
