...
const Layout7 = () => {
  ...
  const unitBisnis = [
    { id: 1, name: "Grand Cordela Hotel Kuningan", desc: "Lokasi: Jl. Siliwangi No.91, Purwawinangun, Kec. Kuningan, Kabupaten Kuningan, Jawa Barat 45511 ", img: "https://images.unsplash.com/photo-1516467508483-a7212febe31a?q=80&w=600" },
    { id: 2, name: "Bulak Laut Hotel & Resort", desc: "Lokasi: Jl. Pantai Barat, Pangandaran, Kec. Pangandaran Jawa Barat, Pantai Barat, Pangandaran, Indonesia, 46396", img: "https://images.unsplash.com/photo-1547496502-affa22d38842?q=80&w=600" },
    { id: 3, name: "Amanara Villa", desc: "Lokasi: Jl. Pantai Barat, RT 005 RW 005 Pangandaran Beach West Java, Indonesia. ", img: "https://images.unsplash.com/photo-1594913366159-1832ffef867d?q=80&w=600" },
    ];
