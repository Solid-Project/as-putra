...
import bgLayout from "@/assets/img/hotel6.jpeg";
          ...
          <div ref={listRef} className="lg:col-span-5 space-y-10 lg:mt-32">
            ...
            <div className="text-reveal flex gap-6 group">
              ...
              <div>
                ...
                <p className="text-slate-500 leading-relaxed font-light text-sm border-l border-slate-100 pl-6 group-hover:border-[var(--color-utama)] transition-all">
                Ruang istirahat berdesain modern dengan tingkat kenyamanan absolut yang menyuguhkan pemandangan menawan kota dan bentang alam Kuningan.
                </p>
              </div>
            </div>
            ...
            <div className="text-reveal flex gap-6 group border-t border-slate-50 pt-10">
              ...
              <div>
                ...
                <p className="text-slate-500 leading-relaxed font-light text-sm border-l border-slate-100 pl-6 group-hover:border-[var(--color-utama)] transition-all">
                 Memiliki 2 ruang pertemuan representatif dan 1 ballroom elegan yang siap mewujudkan kesuksesan agenda bisnis maupun momen spesial Anda.
                </p>
              </div>
            </div>
            ...
            <div className="text-reveal flex gap-6 group border-t border-slate-50 pt-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">
                  Relaksasi & Gastronomi
                </h3>
                <p className="text-slate-500 leading-relaxed font-light text-sm border-l border-slate-100 pl-6 group-hover:border-[var(--color-utama)] transition-all">
                 Dilengkapi dengan fasilitas kolam renang eksklusif dan restoran premium untuk melengkapi pengalaman menginap yang tak terlupakan.
                </p>
              </div>
            </div>
          </div>
