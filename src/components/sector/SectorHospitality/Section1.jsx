          ...
          <div className="lg:col-span-5 lg:col-start-8 z-30 mt-1 lg:mt-0">
            ...
            >
              ...
              <p className="text-slate-500 text-lg leading-relaxed font-light mb-1 border-l border-slate-100 pl-8">
                AS Putra Group menetapkan standar baru dalam layanan hospitality. Kami merancang setiap destinasi dengan memadukan kenyamanan, keanggunan, dan pelayanan premium untuk memberikan pengalaman menginap yang tak terlupakan.
              </p>
