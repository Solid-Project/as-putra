...
import bgLayout from '@/assets/img/hotel4.jpeg';
        ...
        <div className="grid lg:grid-cols-12 gap-0 items-start">
          ...
          <div className="lg:col-span-7 relative group">
            ...
            <div className="absolute -bottom-6 -left-6 bg-[var(--color-utama)] text-white p-8 hidden md:block shadow-xl">
               <p className="text-xs font-bold tracking-[0.3em] uppercase mb-2 opacity-80">Bulak Laut Hotel & Resort</p>
               <h4 className="text-4xl font-black font-['Playfair_Display']">Feel The Breeze</h4>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 lg:-ml-20 mt-12 lg:mt-32 z-20">
            ...
            >
              <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl text-slate-900 font-bold mb-8 leading-tight">
                Gerbang Eksotisme Pantai Pangandaran
              </h2>
              <p className="text-slate-600 leading-relaxed mb-12 text-lg font-light">
            Berada di titik paling strategis Jalan Bulak Laut, resor ini adalah gerbang utama menuju pesona alam Jawa Barat. Hanya beberapa langkah dari hamparan pasir putih legendaris Pantai Barat Pangandaran, memberikan Anda akses langsung untuk menyatu dengan keindahan laut tanpa batas.
              </p>
