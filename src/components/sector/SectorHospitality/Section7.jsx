...
import peternakanImg from "@/assets/img/hotel6.jpeg";
          ...
          >
            <div className="max-w-xl">
              ...
              <h2 className="font-['Playfair_Display'] text-4xl md:text-6xl lg:text-7xl text-slate-900 font-bold leading-[1.1] mb-8 tracking-tighter">
                Kemewahan Personal &  <br />
                <span className="text-[var(--color-utama)]">Ruang Eksklusif</span>
              </h2>
             ...
             Setiap sudut dan arsitektur vila dikurasi dengan presisi tingkat tinggi untuk menjaga privasi maksimal Anda. Nikmati perpaduan harmonis antara kemewahan ruang personal yang tak tertandingi dan eksotisme alam Pangandaran dalam satu pelayanan berstandar kelas atas.
              </p>
            </div>
          </div>
