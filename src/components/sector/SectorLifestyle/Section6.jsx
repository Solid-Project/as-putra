...
import bgLayout from "@/assets/img/kiara2.webp";
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                >
                  <span className="italic">{data.description[0].title}</span>{" "}
                     Mitra terpercaya untuk kesehatan keluarga Anda. Berlokasi di kawasan Cijoho, Apotek Kiara berdiri sebagai garda terdepan dalam penyediaan kebutuhan farmasi yang lengkap, menjamin aksesibilitas obat-obatan berkualitas bagi seluruh masyarakat.
