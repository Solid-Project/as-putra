...
import peternakanImg from "@/assets/img/kiara.webp";
          ...
          >
            <div className="max-w-xl">
              ...
              <h2 className="font-['Playfair_Display'] text-4xl md:text-6xl lg:text-7xl text-slate-900 font-bold leading-[1.1] mb-8 tracking-tighter">
                Pelayanan Farmasi Prima <br />
                <span className="text-[var(--color-utama)]">& Terintegrasi</span>
              </h2>
            ...
            Kami berkomitmen pada keaslian produk dan kecepatan pelayanan. Apotek Kiara didukung oleh manajemen distribusi yang baik untuk memastikan ketersediaan suplai medis harian Anda terpenuhi dengan standar keamanan dan kepercayaan yang tinggi.
