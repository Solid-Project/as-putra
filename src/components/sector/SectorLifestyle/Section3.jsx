...
import bgLayout from '@/assets/img/tgw3.webp'
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div ref={listRef} className="lg:col-span-5 space-y-10 lg:mt-32">
            ...
            <div className="text-reveal flex gap-6 group">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">Private Gym Facility</h3>
                <p className="text-slate-500 leading-relaxed font-light text-sm border-l border-slate-100 pl-6 group-hover:border-[var(--color-utama)] transition-all">
                 Peralatan kebugaran modern yang didesain khusus untuk memenuhi kebutuhan anatomi dan target latihan wanita.
                </p>
              </div>
            </div>
            ...
            <div className="text-reveal flex gap-6 group border-t border-slate-50 pt-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">Dynamic Classes</h3>
                <p className="text-slate-500 leading-relaxed font-light text-sm border-l border-slate-100 pl-6 group-hover:border-[var(--color-utama)] transition-all">
                  Beragam kelas grup intensif mulai dari Zumba dan K-Pop Dance untuk energi maksimal.
                </p>
              </div>
            </div>
            ...
            <div className="text-reveal flex gap-6 group border-t border-slate-50 pt-10">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-3 tracking-tight">Wellness & Balance</h3>
                <p className="text-slate-500 leading-relaxed font-light text-sm border-l border-slate-100 pl-6 group-hover:border-[var(--color-utama)] transition-all">
                Program latihan terfokus seperti Pilates untuk meningkatkan kekuatan inti, fleksibilitas, dan keseimbangan tubuh.
                </p>
              </div>
            </div>
