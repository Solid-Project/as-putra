...
import peternakanImg from "@/assets/img/Carousel/herocarousel2.webp";
          ...
          >
            <div className="max-w-xl">
              ...
              <h2 className="font-['Playfair_Display'] text-4xl md:text-6xl lg:text-7xl text-slate-900 font-bold leading-[1.1] mb-8 tracking-tighter">
                AS PUTRA <br />
                <span className="text-[var(--color-utama)]">SINERGI PERDANA</span>
              </h2>
              ...
              <p className="text-slate-600 text-base md:text-lg leading-relaxed font-light border-l-2 border-slate-50 pl-6">
               Fasilitas pengolahan daging berstandar global. Kami mengoperasikan Rumah Potong Ayam terintegrasi dengan teknologi mutakhir untuk memastikan kebersihan dan presisi di setiap tahap produksi.
              </p>
            </div>
          </div>
