...
const Section1 = () => {
  ...
  const data = {
    ...
    image: bgLayout,
    description: [
      "Lokasi: Kuningan (Wilanegara, Cinagara, Awirarangan)",
      "Produk: DOC, Hatching Eggs, Hatchery, Breeding Farm",
      "Fokus: Pengembangan genetika unggul dan kualitas bibit ayam",
    ],
  };
  ...
  >
  Pusat keunggulan genetika unggas modern. Kami menerapkan protokol biosecurity yang ketat dan manajemen pemeliharaan tingkat tinggi untuk memastikan setiap indukan menghasilkan keturunan dengan kualitas genetik terbaik di kelasnya
  </p>
</div>
