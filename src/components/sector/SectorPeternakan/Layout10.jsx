...
import bgLayout from '@/assets/img/Carousel/herocarousel4.jpg';
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 lg:col-start-8 z-30 mt-12 lg:mt-0">
            ...
            >
             ...
             Mengintegrasikan teknologi mutakhir dan keahlian mendalam.
              </h2>
              <p className="text-slate-500 text-lg leading-relaxed font-light mb-12 border-l border-slate-100 pl-8">
               Sektor Peternakan AS Putra Group menetapkan standar emas dalam industri perunggasan nasional. Dari pusat pembibitan genetik hingga fasilitas pengolahan modern, kami mengelola rantai pasok terintegrasi yang tangguh, efisien, dan berkualitas premium untuk mendukung penuh ketahanan pangan Indonesia.
              </p>
