...
import bgLayout from '@/assets/img/ceha.jpg';
          ...
          <div className="lg:col-span-5 lg:-ml-20 mt-12 lg:mt-32 z-20">
            ...
            >
              <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl text-slate-900 font-bold mb-8 leading-tight">
                Sertifikasi Halal & <br/> Standar NKV
              </h2>
              <p className="text-slate-600 leading-relaxed mb-12 text-lg font-light">
              Komitmen absolut pada keamanan pangan. Kami secara konsisten menjaga kualitas daging ayam premium agar selalu aman, sehat, dan higienis untuk dihadirkan kepada seluruh pelanggan.
              </p>
