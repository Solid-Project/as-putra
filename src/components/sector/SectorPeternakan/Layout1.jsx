...
const Layout1 = () => {
  ...
  >
    {`${data.title} berlokasi di ${data.description[0].replace("Lokasi: ", "")}. ${data.title} berfokus pada ${data.description[1].replace("Produk: ", "")}. Fokus utama pengembangannya adalah ${data.description[2].replace("Fokus: ", "")}.`}
  </p>
</div>
