          ...
          <div className="lg:col-span-5 lg:-ml-20 mt-12 lg:mt-32 z-20">
            ...
            >
              <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl text-slate-900 font-bold mb-8 leading-tight">
                AS Putra Close House 
              </h2>
              <p className="text-slate-600 leading-relaxed mb-12 text-lg font-light">
               Inovasi pemeliharaan unggas pedaging berbasis closed house farm. Sistem ini menciptakan lingkungan terkontrol yang presisi untuk pemeliharaan Broiler, menghasilkan Livebird yang sehat dengan standar efisiensi dan higienitas maksimal.
              </p>
