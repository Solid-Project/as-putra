      ...
      <div className="w-full">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-100">
          ...
          <div className="text-xs font-bold text-gray-400 hidden sm:block">
            {jobOpeningsData.length} Posisi Tersedia
          </div>
        </div>
          ...
          {jobOpeningsData.map((job, index) => (
            ...
            >
              <div className="flex-1">
                ...
                <h4 
                  className="text-xl md:text-2xl font-['Playfair_Display'] font-bold mb-3 transition-transform duration-300 group-hover:translate-x-1" 
                ...
                <div className="flex flex-wrap gap-x-6 gap-y-2">
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span className="text-xs md:text-sm font-semibold">{job.location}</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600">
                    <AcademicCapIcon className="w-4 h-4 shrink-0" style={{ color: COLOR_GOLD }} />
                    <span className="text-xs md:text-sm font-semibold">{job.requirement}</span>
                  </div>
                </div>
              </div>
