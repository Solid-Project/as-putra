...
const VissionMission = ({ data, activeIndex, index }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className="section relative w-full h-[100vh] flex items-center justify-center bg-white overflow-hidden"
      id={`section-${index}`}
      data-theme="light"
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
          ...
          <div ref={leftRef} className="space-y-6">
            ...
            <div className="max-w-md">
              <p className="text-gray-600 text-sm md:text-base leading-relaxed border-l-2 border-[#FFC619] pl-6 text-justify font-medium">
                {data.description}
              </p>
            </div>
