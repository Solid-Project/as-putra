  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: "60%",
        height: "100%",
        background: "radial-gradient(circle, rgba(250, 204, 21, 0.05) 0%, rgba(250, 204, 21, 0) 70%)",
        borderRadius: "50%",
        pointerEvents: "none"
      }} />
      ...
      <div className="w-full mx-auto" style={{
        ...
        <div ref={headerRef} style={{
          ...
          <div style={{
            width: "60px",
            height: "4px",
            background: "linear-gradient(90deg, var(--color-utama), var(--color-aksen))",
        ...
        <div className="grid md:grid-cols-3 gap-6" style={{
          ...
          {news.map((item, idx) => {
            const category = categoryConfig[item.category] || categoryConfig.event;
            return (
              <Link
                key={item.id}
                to={`/news/${item.id}`}
              ...
              >
                ...
                <div className="p-5 flex flex-col justify-between h-full">
                  ...
                  <div className="flex items-center gap-2 group-hover:gap-3 transition-all">
                    ...
                    <span className="text-sm font-semibold text-[var(--color-utama)]">→</span>
                  </div>
                </div>
              </Link>
            );
        ...
        <div ref={buttonRef} style={{ textAlign: "center" }}>
          <Link
            ...
            style={{
              background: "linear-gradient(135deg, var(--color-utama), var(--color-utama-hover))",
              boxShadow: "0 10px 15px -3px rgba(30, 58, 138, 0.3)"
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = "scale(1.05)";
              e.currentTarget.style.boxShadow = "0 20px 25px -5px rgba(30, 58, 138, 0.4)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "scale(1)";
              e.currentTarget.style.boxShadow = "0 10px 15px -3px rgba(30, 58, 138, 0.3)";
            }}
          >
            Lihat Semua Berita
          </Link>
